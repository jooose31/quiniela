                            ...
                            <div class="col-md-6 no-padding wow rollIn">
                                <div class="main_home_area p-t-2 p-x-3">
                                    ...
                                    <div class="single_contant_right">
                                        <form action="agequipo.php" id="formid" method="post">
                                            <div class="row">
                                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="file" class="form-control" name="bandera" placeholder="Bandera" required="">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="main_footer">
                                            ...
                                            <div class="col-md-8">
                                                <div class="copyright_text margin-top-20 center">
                                                    <p class=" wow fadeInRight animated" data-wow-duration="1s"> Para iniciar sesion haga
                                                         <a  href="ingresar.html">click aqui</a></p>
                                                </div>
                                            </div>
